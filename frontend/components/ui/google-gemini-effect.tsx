...
/* Credit to Alvina Yang for design inspiration */
    ...
    <>
      <div className={cn("sticky top-80", className)}>
        ...
        <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
          {description ||
            `Introducing the Latest Version of `}
          <motion.span
            style={{
              backgroundClip: "text",
              WebkitBackgroundClip: "text",
              color: "transparent",
              backgroundImage: "linear-gradient(45deg, #3b82f6, #2563eb, #1d4ed8)",
      ...
      <div className="fixed flex flex-col items-center justify-center left-1/2 bottom-8 transform -translate-x-1/2">
        <motion.div
        ...
        <p className="mt-4 text-blue-300 text-sm">Scroll Down</p>
      </div>
    </>
  );
};
